...
function ProjectDetails({ project, onBack }) {
    ...
    return (
        ...
        >
            {/* Header */}
            <div className="fixed top-0 left-0 right-0 z-50 h-12 flex items-center justify-between border-b border-black/10">
                <motion.button
                    onClick={onBack}
            ...
            <div className="h-screen pt-12">
                <div className="flex flex-col md:flex-row h-full">
                    {/* Media Section */}
                    <div className={`md:w-2/3 h-full relative ${showDetailsMobile ? 'hidden md:block' : ''}`}>
                        <motion.div
                            ref={mediaPanelRef}
                    ...
                    {/* Details Section */}
                    <div className={`md:w-1/3 h-full overflow-y-auto border-l border-black/10 ${!showDetailsMobile ? 'hidden md:block' : ''}`}>
